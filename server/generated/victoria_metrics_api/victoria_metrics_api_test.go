...
func TestQueryRange(t *testing.T) {
	...
	if err := fast.FromJSON(body); err != nil {
...
/*
go test -test.fullpath=true -timeout 30s -v -run ^TestQueryRangeFromJsonFile$ github.com/ahfuzhang/MetricsExplorer/server/generated/vectoria_metrics_api
*/
func TestQueryRangeFromJsonFile(t *testing.T) {
	body, err := os.ReadFile("./not_use/1.json")
	if err != nil {
	...
	t.Logf("cnt=%d", len(fast.Data.Result))
	t.Logf("0 cnt=%d", len(fast.Data.Result[0].Values))
